<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a class="nav-link" href="<?php echo base_url('transaksi'); ?>"><i class="far fa-square"></i>
                    <span>Transaksi</span></a></li>
            <li><a class="nav-link" href="<?php echo base_url('customer'); ?>"><i class="far fa-square"></i>
